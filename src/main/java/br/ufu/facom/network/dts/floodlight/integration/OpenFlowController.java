...
public class OpenFlowController extends Controller{
	...
	protected void init() {
		...
		dealer = new Module();
		dealer.setFloodlightProvider(this);
		dealer.setStorageSource(storageSource);
		dealer.setFlowEntryPusher(staticFlowEntryPusher);
	}
